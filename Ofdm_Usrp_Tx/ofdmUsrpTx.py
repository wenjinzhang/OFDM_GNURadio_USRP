...
class ofdmUsrpTx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/daisylab-6/workarea/OFDM_GNURadio_USRP/Ofdm_Usrp_Tx/file_Tx.txt', True)
        ...
        self.connect((self.digital_ofdm_mod_0, 0), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=ofdmUsrpTx, options=None):
